...
<div class="main-poster-div">
            <div class="main-poster">
               <h2 class="main-poster-text"><strong>Posters</strong></h2>
            </div>
               ...
               <div class="swiper mySwiper">
                  <div class="swiper-wrapper">
                     ...
                     <div class="elements-card-slider" style="text-align: center;">
                        <img src="../assets/posters/poster1.jpg" style="width: 50%;" alt="cover">
                        <p>Ceza Yerli Plaka</p>
                        <p>15 $</p>
                  ...
                  <div style="text-align: right; padding-right: 12px;">
                     <a href="all-poster.php">Show All</a>
                  </div>
                </div>
            </div>
         </div>
